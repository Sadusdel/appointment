...
<?php else: while($row=$appointments->fetch_assoc()): ?><article class="appointment"><div class="time"><?php echo htmlspecialchars(substr($row['appointment_time'],0,5),ENT_QUOTES,'UTF-8'); ?></div><div><div class="patient-name"><?php echo htmlspecialchars($row['Fname'],ENT_QUOTES,'UTF-8'); ?></div><div class="patient-details"><?php echo htmlspecialchars($row['Gender'],ENT_QUOTES,'UTF-8'); ?> · <?php echo htmlspecialchars($row['clinic_name']??'Klinik',ENT_QUOTES,'UTF-8'); ?></div></div><div class="status-area"><span class="status <?php echo statusLabel($row['Status']); ?>"><?php echo htmlspecialchars($row['Status'],ENT_QUOTES,'UTF-8'); ?></span></div></article><?php endwhile; endif; ?>
</div></section>
</main>
</body>
</html>