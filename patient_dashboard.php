...
<script>`r`nfunction confirmCancel(form) {`r`n    return window.confirm('Bu randevuyu iptal etmek istediğinizden emin misiniz?\\n\\nBu işlem geri alınamaz.');`r`n}`r`n</script>`r`n</script>
</body></html>
<?php $stmt->close(); ?>
